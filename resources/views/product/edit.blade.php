                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="@error('image')border border-danger rounded-3 @enderror">
                                <input class="form-control"  type="file"  id="welcome-image" name="file">
                                    @error('file')
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                @foreach($tags as $tag)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="tags[]" value="{{ $tag->id }}" id="tag{{ $tag->id }}" {{ in_array($tag->id, $product->tags->pluck('id')->toArray()) ? 'checked' : '' }}>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <input required class="form-control" value="{{ $product->title }}" type="text" id="welcome-title" name="title">
                                    @error('title')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <input required class="form-control" value="{{ $product->price }}" type="text" id="welcome-title" name="price">
                                    @error('title')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
