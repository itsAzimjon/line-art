                ...
                <div class="row">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                @foreach($tags as $tag)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="tags[]" value="{{ $tag->id }}" id="tag{{ $tag->id }}" {{ in_array($tag->id, $article->tags->pluck('id')->toArray()) ? 'checked' : '' }}>
                    ...
                    <div class="col-12 my-1">
                        <div class="form-group">
                            ...
                            <div class="@error('welcome.title')border border-danger rounded-3 @enderror">
                                <input required class="form-control" type="text" id="welcome-title" value="{{ $article->title }}" name="title">
                                    @error('title')
