...
<div class="container">
    ...
    <div class="row block-center px-5 mx-5">
        <div class="user_title col-12 py-4">
            <h1>{{ $article->title }}</h1>
        </div>
            ...
            <div class="user_page_right d-flex  col-12">
                <div class="row ">
                    <div class="col-12 mx-5">
                        <img style="height: 450px; object-fit:cover" src="{{ asset('storage/' . json_decode($article->photo)[0]) }}" alt="">
                    </div>
                </div>  
            </div> 
        </div>
        <div class="col-12">
            ...
            <div class="row ">
                @foreach (array_slice(json_decode($article->photo), 1) as $image)
                    <div class="my-3">
                        <img class="w-100" style="height: 450px; object-fit:cover" src="{{ asset('storage/' . $image) }}" alt="">
                    </div>
                @endforeach
            </div> 
        ...
        <div class="row d-flex">
            ...
            <div class="d-inline">
                @foreach ($article->tags as $tag)
                    <button class="d-inline btn-lg fw-bold btn metka_btn border">{{ $tag->name }}</button>
                @endforeach
            </div>
        </div>
    </div>
