...
@section('content')
    ...
    <nav>
        ...
        <ul class="ul_kniga">
            ...
            <li><a href="./page_2.html">Книги</a></li>
            <li><a href="#">Чертежи</a></li>
            <li><a href="#">Курсы</a></li>
            <li><a href="#">Нормативы</a></li>
            <li><a href="#">Расчёты</a></li>
        </ul>
    ...
    <div class="row p-0 block mt-3">
        <div class="col-2 mb-4">
            ...
            <div class="card in">
                ...
                <div class="card-body">
                    <h5 class="card-title">The Classical Language of Arch...</h5>
                    <p class="card-text">Градостроительство &nbsp;
